...
object WBApi : SdkListener, WbAuthListener {
    ...
    object Status {
        internal var initSucceed: Boolean = false
        internal var tokenAccess: String = ""
        internal var tokenRefresh: String = ""
        internal var expireTime: String = ""
        internal var authUid: String = ""

        val isInitSucceed: Boolean
        get() = this.initSucceed

        val isValid: Boolean
        get() = this.tokenAccess.isNotEmpty() && this.tokenRefresh.isNotEmpty() && this.authUid.isNotEmpty() && this.expireTime.isNotEmpty()
    ...
    override fun onComplete(token: Oauth2AccessToken?) {
        ...
        Status.expireTime = token.expiresTime.toString()
